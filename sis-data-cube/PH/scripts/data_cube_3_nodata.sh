...
gdal_calc.py --quiet -A PH-GSAS-PHX-2020-0-30-MEAN.tif -B PH-GSAS-SALT-2020-0-30-MEAN.tif --outfile=temp.tif --calc="where(A==-1, -1, B)" --NoDataValue=-1 --overwrite && mv temp.tif PH-GSAS-SALT-2020-0-30-MEAN.tif
gdal_calc.py --quiet -A PH-GSAS-PHX-2020-0-30-MEAN.tif -B PH-GSAS-SALT-2020-30-100-MEAN.tif --outfile=temp.tif --calc="where(A==-1, -1, B)" --NoDataValue=-1 --overwrite && mv temp.tif PH-GSAS-SALT-2020-30-100-MEAN.tif
