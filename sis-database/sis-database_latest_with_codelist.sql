...
COPY api."user" (user_id, password_hash, is_active, is_admin, created_at, updated_at, last_login, password_changed_at, failed_login_attempts, locked_until) FROM stdin;
\.
